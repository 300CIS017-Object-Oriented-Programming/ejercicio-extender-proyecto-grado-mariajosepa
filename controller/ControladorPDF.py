    ...
    def exportar_acta(self, st, controlador, acta_seleccionada):
        ...
        for acta in controlador.actas:
            if acta.autor == acta_seleccionada:
                self.pdf.multi_cell(185, 6, txt=f"Trabajo de grado denominado: {acta.nombre_trabajo}",
                       align='L')
        for acta in controlador.actas:
            if acta.autor == acta_seleccionada:
                flag = True
                ...
                self.pdf.cell(200, 10, txt=f"Fecha de Presentacion:                  {acta.fecha_presentacion}", ln=1, align='L')
                ...
                for criterio in acta.criterios:
                    ...
                    self.pdf.multi_cell(185, 7, txt=f"Observación adicional: {criterio.observacion_extra}", align='L')
